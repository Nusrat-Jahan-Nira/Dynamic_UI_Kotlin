...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun fetchRegistrationForm() {
        RetrofitClient.apiService.fetchRegistrationForm().enqueue(object : Callback<RegistrationFormResponse> {
    ...
    private fun registerUser() {
        ...
        RetrofitClient.apiService.registerUser(registrationRequest).enqueue(object : Callback<RegistrationResponse> {
